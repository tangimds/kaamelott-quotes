...
const _includes = (a, b) => a === null || a === void 0 ? void 0 : a.toLowerCase().includes(b === null || b === void 0 ? void 0 : b.toLowerCase());
...
const _random = array => array && array[Math.floor(Math.random() * array.length)] || notFoundQuotes[Math.floor(Math.random() * notFoundQuotes.length)];
